"""CLI test for PartDesign_Chain command.
...
try:
    ...
    cmd = cm.getCommandByName("PartDesign_Chain")
    if cmd is None:
        errors.append("command 'PartDesign_Chain' is not registered in the command manager")
    else:
