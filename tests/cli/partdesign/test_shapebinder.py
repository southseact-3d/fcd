"""CLI test for PartDesign_ShapeBinder command.
...
COMMAND_ID = "PartDesign_ShapeBinder"
TIMEOUT = 30
...
try:
    ...
    cmd = cm.getCommandByName("PartDesign_ShapeBinder")
    if cmd is None:
        errors.append("command 'PartDesign_ShapeBinder' is not registered in the command manager")
    else:
