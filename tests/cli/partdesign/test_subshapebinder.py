"""CLI test for PartDesign_SubShapeBinder command.
...
COMMAND_ID = "PartDesign_SubShapeBinder"
TIMEOUT = 30
...
try:
    ...
    cmd = cm.getCommandByName("PartDesign_SubShapeBinder")
    if cmd is None:
        errors.append("command 'PartDesign_SubShapeBinder' is not registered in the command manager")
    else:
