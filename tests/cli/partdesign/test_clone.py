"""CLI test for PartDesign_Clone command.

verifies Clone duplicates a Body
...
try:
    ...
    cmd = cm.getCommandByName("PartDesign_Clone")
    if cmd is None:
        errors.append("command 'PartDesign_Clone' is not registered in the command manager")
    else:
