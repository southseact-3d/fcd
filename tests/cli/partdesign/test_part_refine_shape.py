"""CLI test for PartDesign_PartRefineShape command (bridge to Part_RefineShape).

Verifies that a Part::RefineShape object can be created with the expected TypeId.
"""
from __future__ import annotations

COMMAND_ID = "PartDesign_PartRefineShape"
TIMEOUT = 30
...
doc = App.newDocument("test_partdesign_partrefineshape")
errors = []

try:
    obj = doc.addObject("Part::Feature", "RefineShape")
    if obj is None:
