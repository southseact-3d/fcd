"""CLI test for PartDesign_PartOffset command (bridge to Part_Offset).

Verifies that a Part::Offset object can be created with the expected TypeId.
"""
from __future__ import annotations

COMMAND_ID = "PartDesign_PartOffset"
TIMEOUT = 30
...
doc = App.newDocument("test_partdesign_partoffset")
errors = []
