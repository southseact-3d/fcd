"""CLI test for PartDesign_DuplicateSelection command.

verifies DuplicateSelection duplicates a feature
...
COMMAND_ID = "PartDesign_DuplicateSelection"
TIMEOUT = 30
...
try:
    ...
    cmd = cm.getCommandByName("PartDesign_DuplicateSelection")
    if cmd is None:
        errors.append("command 'PartDesign_DuplicateSelection' is not registered in the command manager")
    else:
