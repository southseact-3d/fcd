"""CLI test for PartDesign_WizardShaft command.
...
COMMAND_ID = "PartDesign_WizardShaft"
TIMEOUT = 30
...
try:
    ...
    cmd = cm.getCommandByName("PartDesign_WizardShaft")
    if cmd is None:
        errors.append("command 'PartDesign_WizardShaft' is not registered in the command manager")
    else:
