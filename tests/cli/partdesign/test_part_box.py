"""CLI test for PartDesign_PartBox command (bridge to Part_Box).

Verifies that a Part::Box object can be created with the expected TypeId.
"""
from __future__ import annotations

COMMAND_ID = "PartDesign_PartBox"
TIMEOUT = 30
...
doc = App.newDocument("test_partdesign_partbox")
errors = []
...
try:
    ...
    if obj is None:
        ...
        if obj.TypeId != "Part::Box":
            errors.append(f"wrong TypeId: {obj.TypeId} (expected Part::Box)")
        doc.recompute()
