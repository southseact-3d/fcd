"""CLI test for PartDesign_PartTransformedCopy command (bridge to Part_TransformedCopy).

Verifies that a Part::TransformedCopy object can be created with the expected TypeId.
"""
from __future__ import annotations

COMMAND_ID = "PartDesign_PartTransformedCopy"
TIMEOUT = 30
...
doc = App.newDocument("test_partdesign_parttransformedcopy")
errors = []

try:
    obj = doc.addObject("Part::Feature", "TransformedCopy")
    if obj is None:
