"""CLI test for PartDesign_MoveFeature command.

verifies MoveFeature moves a feature to another Body
...
COMMAND_ID = "PartDesign_MoveFeature"
TIMEOUT = 30
...
try:
    ...
    cmd = cm.getCommandByName("PartDesign_MoveFeature")
    if cmd is None:
        errors.append("command 'PartDesign_MoveFeature' is not registered in the command manager")
    else:
