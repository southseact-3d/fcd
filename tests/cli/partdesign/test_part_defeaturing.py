"""CLI test for PartDesign_PartDefeaturing command (bridge to Part_Defeaturing).

Verifies that a Part::Defeaturing object can be created with the expected TypeId.
"""
from __future__ import annotations

COMMAND_ID = "PartDesign_PartDefeaturing"
TIMEOUT = 30
...
doc = App.newDocument("test_partdesign_partdefeaturing")
errors = []

try:
    obj = doc.addObject("Part::Feature", "Defeaturing")
    if obj is None:
