"""CLI test for PartDesign_MoveTip command.

verifies MoveTip can be invoked on a Body with a feature
...
try:
    ...
    cmd = cm.getCommandByName("PartDesign_MoveTip")
    if cmd is None:
        errors.append("command 'PartDesign_MoveTip' is not registered in the command manager")
    else:
