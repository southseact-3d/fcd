"""CLI test for PartDesign_WizardShaftCallBack command.

shaft wizard callback
...
COMMAND_ID = "PartDesign_WizardShaftCallBack"
TIMEOUT = 30
...
try:
    ...
    cmd = cm.getCommandByName("PartDesign_WizardShaftCallBack")
    if cmd is None:
        errors.append("command 'PartDesign_WizardShaftCallBack' is not registered in the command manager")
    else:
