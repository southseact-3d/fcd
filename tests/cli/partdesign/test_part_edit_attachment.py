"""CLI test for PartDesign_PartEditAttachment command.

Bridge to Part command (dialog: Edit attachment)
...
COMMAND_ID = "PartDesign_PartEditAttachment"
TIMEOUT = 30
...
try:
    ...
    cmd = cm.getCommandByName("PartDesign_PartEditAttachment")
    if cmd is None:
        errors.append("command 'PartDesign_PartEditAttachment' is not registered in the command manager")
    else:
