"""CLI test for PartDesign_PartSlice command.

Bridge to Part command (dialog: Slice)
...
COMMAND_ID = "PartDesign_PartSlice"
TIMEOUT = 30
...
try:
    ...
    cmd = cm.getCommandByName("PartDesign_PartSlice")
    if cmd is None:
        errors.append("command 'PartDesign_PartSlice' is not registered in the command manager")
    else:
