"""CLI test for PartDesign_MigratePartMacros command.

verifies MigratePartMacros command exists
...
COMMAND_ID = "PartDesign_MigratePartMacros"
TIMEOUT = 30
...
try:
    ...
    cmd = cm.getCommandByName("PartDesign_MigratePartMacros")
    if cmd is None:
        errors.append("command 'PartDesign_MigratePartMacros' is not registered in the command manager")
    else:
