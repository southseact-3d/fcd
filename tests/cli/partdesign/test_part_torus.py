"""CLI test for PartDesign_PartTorus command (bridge to Part_Torus).

Verifies that a Part::Torus object can be created with the expected TypeId.
"""
from __future__ import annotations

COMMAND_ID = "PartDesign_PartTorus"
TIMEOUT = 30
...
doc = App.newDocument("test_partdesign_parttorus")
errors = []
...
try:
    ...
    if obj is None:
        ...
        if obj.TypeId != "Part::Torus":
            errors.append(f"wrong TypeId: {obj.TypeId} (expected Part::Torus)")
        doc.recompute()
