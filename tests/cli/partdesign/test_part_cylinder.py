"""CLI test for PartDesign_PartCylinder command (bridge to Part_Cylinder).

Verifies that a Part::Cylinder object can be created with the expected TypeId.
"""
from __future__ import annotations

COMMAND_ID = "PartDesign_PartCylinder"
TIMEOUT = 30
...
doc = App.newDocument("test_partdesign_partcylinder")
errors = []
