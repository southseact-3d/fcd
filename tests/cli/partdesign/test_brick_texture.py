"""CLI test for PartDesign_BrickTexture command."""
from __future__ import annotations
COMMAND_ID = "PartDesign_BrickTexture"
TIMEOUT = 60
SCRIPT = r"""
import sys, json
...
doc = App.newDocument("test_brick_texture")
...
bt = body.newObject("PartDesign::BrickTexture", "BrickTexture")
bt.Base = pad
shape = pad.Shape
top_face = None
...
errors = []
if bt is None:
    errors.append("BrickTexture object was not created")
else:
    if not bt.TypeId.startswith("PartDesign::BrickTexture"):
