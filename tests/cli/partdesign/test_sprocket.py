"""CLI test for PartDesign_Sprocket command.
...
COMMAND_ID = "PartDesign_Sprocket"
TIMEOUT = 30
...
try:
    ...
    cmd = cm.getCommandByName("PartDesign_Sprocket")
    if cmd is None:
        errors.append("command 'PartDesign_Sprocket' is not registered in the command manager")
    else:
