"""CLI test for PartDesign_PartSimpleCopy command (bridge to Part_SimpleCopy).

Verifies that a Part::SimpleCopy object can be created with the expected TypeId.
"""
from __future__ import annotations

COMMAND_ID = "PartDesign_PartSimpleCopy"
TIMEOUT = 30
...
doc = App.newDocument("test_partdesign_partsimplecopy")
errors = []

try:
    obj = doc.addObject("Part::Feature", "SimpleCopy")
    if obj is None:
