"""CLI test for PartDesign_PartBooleanFragments command.

Bridge to Part command (dialog: Boolean fragments)
...
COMMAND_ID = "PartDesign_PartBooleanFragments"
TIMEOUT = 30
...
try:
    ...
    cmd = cm.getCommandByName("PartDesign_PartBooleanFragments")
    if cmd is None:
        errors.append("command 'PartDesign_PartBooleanFragments' is not registered in the command manager")
    else:
