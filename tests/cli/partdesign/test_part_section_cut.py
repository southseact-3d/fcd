"""CLI test for PartDesign_PartSectionCut command.

Bridge to Part command (dialog: Section cut)
...
COMMAND_ID = "PartDesign_PartSectionCut"
TIMEOUT = 30
...
try:
    ...
    cmd = cm.getCommandByName("PartDesign_PartSectionCut")
    if cmd is None:
        errors.append("command 'PartDesign_PartSectionCut' is not registered in the command manager")
    else:
