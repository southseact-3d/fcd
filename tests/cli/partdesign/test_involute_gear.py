"""CLI test for PartDesign_InvoluteGear command.
...
COMMAND_ID = "PartDesign_InvoluteGear"
TIMEOUT = 30
...
try:
    ...
    cmd = cm.getCommandByName("PartDesign_InvoluteGear")
    if cmd is None:
        errors.append("command 'PartDesign_InvoluteGear' is not registered in the command manager")
    else:
