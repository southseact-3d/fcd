"""CLI test for PartDesign_PartXor command.

Bridge to Part command (dialog: XOR)
...
try:
    ...
    cmd = cm.getCommandByName("PartDesign_PartXor")
    if cmd is None:
        errors.append("command 'PartDesign_PartXor' is not registered in the command manager")
    else:
