"""CLI test for PartDesign_CompPrimitiveSubtractive command.
...
COMMAND_ID = "PartDesign_CompPrimitiveSubtractive"
TIMEOUT = 30
...
try:
    ...
    cmd = cm.getCommandByName("PartDesign_CompPrimitiveSubtractive")
    if cmd is None:
        errors.append("command 'PartDesign_CompPrimitiveSubtractive' is not registered in the command manager")
    else:
