"""CLI test for PartDesign_PartSliceApart command.

Bridge to Part command (dialog: Slice apart)
...
COMMAND_ID = "PartDesign_PartSliceApart"
TIMEOUT = 30
...
try:
    ...
    cmd = cm.getCommandByName("PartDesign_PartSliceApart")
    if cmd is None:
        errors.append("command 'PartDesign_PartSliceApart' is not registered in the command manager")
    else:
