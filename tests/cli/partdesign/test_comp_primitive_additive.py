"""CLI test for PartDesign_CompPrimitiveAdditive command.
...
COMMAND_ID = "PartDesign_CompPrimitiveAdditive"
TIMEOUT = 30
...
try:
    ...
    cmd = cm.getCommandByName("PartDesign_CompPrimitiveAdditive")
    if cmd is None:
        errors.append("command 'PartDesign_CompPrimitiveAdditive' is not registered in the command manager")
    else:
