"""CLI test for PartDesign_MoveFeatureInTree command.

verifies MoveFeatureInTree reorders a feature
...
COMMAND_ID = "PartDesign_MoveFeatureInTree"
TIMEOUT = 30
...
try:
    ...
    cmd = cm.getCommandByName("PartDesign_MoveFeatureInTree")
    if cmd is None:
        errors.append("command 'PartDesign_MoveFeatureInTree' is not registered in the command manager")
    else:
