"""CLI test for PartDesign_WoodPlankTexture command."""
from __future__ import annotations
COMMAND_ID = "PartDesign_WoodPlankTexture"
TIMEOUT = 60
SCRIPT = r"""
import sys, json
...
doc = App.newDocument("test_wood_plank_texture")
...
bt = body.newObject("PartDesign::WoodPlankTexture", "WoodPlankTexture")
bt.Base = pad
shape = pad.Shape
top_face = None
...
errors = []
if bt is None:
    errors.append("WoodPlankTexture object was not created")
else:
    if not bt.TypeId.startswith("PartDesign::WoodPlankTexture"):
