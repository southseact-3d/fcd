...
DockWindowItems* StdWorkbench::setupDockWindows() const
{
    ...
    root->addDockWidget("Std_ComboView", Qt::LeftDockWidgetArea, Gui::DockWindowOption::Visible);
    root->addDockWidget("Std_BodyList", Qt::LeftDockWidgetArea, Gui::DockWindowOption::Visible);
