...
class MaterialTestCases(unittest.TestCase):
    ...
    def testCalculiXSteel(self):
        ...
        self.assertTrue(
            steel.hasAppearanceModel(self.uuids.BasicRendering)
        ...
        self.assertEqual(
            self.getQuantity(properties["Density"]).UserString,
            self.getQuantity("7900.00 kg/m^3").UserString,
        )
        # self.assertEqual(properties["BulkModulus"], "")
        self.assertAlmostEqual(
            self.getQuantity(properties["PoissonRatio"]).Value, self.getQuantity("0.3").Value
        )
        self.assertEqual(
            self.getQuantity(properties["YoungsModulus"]).UserString,
        ...
        self.assertEqual(
            self.getQuantity(properties["ThermalConductivity"]).UserString,
            self.getQuantity("43.00 W/m/K").UserString,
        )
        self.assertEqual(
            self.getQuantity(properties["ThermalExpansionCoefficient"]).UserString,
        ...
        self.assertAlmostEqual(
            self.getQuantity(properties["Shininess"]).Value, self.getQuantity("0.06").Value
        )
        self.assertEqual(properties["SpecularColor"], "(0.9800, 0.9800, 0.9800, 1.0)")
        self.assertAlmostEqual(
            self.getQuantity(properties["Transparency"]).Value, self.getQuantity("0").Value
        )
        ...
        self.assertEqual(
            steel.getPhysicalValue("ThermalExpansionCoefficient").Format["NumberFormat"], "g"
        )
    ...
    def testLists(self):
        ...
        self.assertEqual(
            testList[0], "Now is the time for all good men to come to the aid of the party"
        )
    ...
    def test2DArray(self):
        ...
        self.assertEqual(
            array.getValue(0, 1).UserString, self.getQuantity("10.00 kg/m^3").UserString
        )
        self.assertEqual(array.getValue(1, 0).UserString, self.getQuantity("20.00 C").UserString)
        self.assertEqual(
            array.getValue(1, 1).UserString, self.getQuantity("20.00 kg/m^3").UserString
        )
        self.assertEqual(array.getValue(2, 0).UserString, self.getQuantity("30.00 C").UserString)
        self.assertEqual(
            array.getValue(2, 1).UserString, self.getQuantity("30.00 kg/m^3").UserString
        )
    ...
    def test3DArray(self):
        ...
        with self.assertRaises(IndexError):
            self.assertEqual(
                array.getDepthValue(-1).UserString, self.getQuantity("10.00 C").UserString
            )
        with self.assertRaises(IndexError):
            self.assertEqual(
                array.getDepthValue(3).UserString, self.getQuantity("10.00 C").UserString
            )
        ...
        self.assertEqual(
            array.getValue(0, 0, 0).UserString, self.getQuantity("11.00 Pa").UserString
        )
        self.assertEqual(
            array.getValue(0, 0, 1).UserString, self.getQuantity("12.00 Pa").UserString
        )
        self.assertEqual(
            array.getValue(0, 1, 0).UserString, self.getQuantity("21.00 Pa").UserString
        )
        self.assertEqual(
            array.getValue(0, 1, 1).UserString, self.getQuantity("22.00 Pa").UserString
        )
        self.assertEqual(
            array.getValue(2, 0, 0).UserString, self.getQuantity("10.00 Pa").UserString
        )
        self.assertEqual(
            array.getValue(2, 0, 1).UserString, self.getQuantity("11.00 Pa").UserString
        )
        self.assertEqual(
            array.getValue(2, 1, 0).UserString, self.getQuantity("20.00 Pa").UserString
        )
        self.assertEqual(
            array.getValue(2, 1, 1).UserString, self.getQuantity("21.00 Pa").UserString
        )
        self.assertEqual(
            array.getValue(2, 2, 0).UserString, self.getQuantity("30.00 Pa").UserString
        )
        self.assertEqual(
            array.getValue(2, 2, 1).UserString, self.getQuantity("31.00 Pa").UserString
        )

        with self.assertRaises(IndexError):
            self.assertEqual(
                array.getValue(0, 0, -1).UserString, self.getQuantity("11.00 Pa").UserString
            )
        with self.assertRaises(IndexError):
            self.assertEqual(
                array.getValue(0, 0, 2).UserString, self.getQuantity("11.00 Pa").UserString
            )
        with self.assertRaises(IndexError):
            self.assertEqual(
                array.getValue(0, -1, 0).UserString, self.getQuantity("11.00 Pa").UserString
            )
        with self.assertRaises(IndexError):
            self.assertEqual(
                array.getValue(0, 2, 0).UserString, self.getQuantity("11.00 Pa").UserString
            )
        with self.assertRaises(IndexError):
            self.assertEqual(
                array.getValue(1, 0, 0).UserString, self.getQuantity("11.00 Pa").UserString
            )
        with self.assertRaises(IndexError):
            self.assertEqual(
                array.getValue(-1, 0, 0).UserString, self.getQuantity("11.00 Pa").UserString
        ...
        with self.assertRaises(IndexError):
            self.assertEqual(
                array.getValue(3, 0, 0).UserString, self.getQuantity("11.00 Pa").UserString
            )
