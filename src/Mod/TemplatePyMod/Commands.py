...
class TemplatePyMod_Cmd1:
    ...
    def GetResources(self):
        return {
            ...
            "ToolTip": "Very unimportand example command",
        }
...
class TemplatePyMod_Cmd2:
    ...
    def GetResources(self):
        return {
            ...
            "ToolTip": "Create a polygon by clicking inside the viewer",
        }
...
class TemplatePyMod_Cmd3:
    ...
    def GetResources(self):
        return {
            "Pixmap": "python",
            "MenuText": "Import PySide",
            "ToolTip": "Add a workbench for PySide samples",
        }
    ...
    def create(self, info):
        ...
        if down:
            ...
            FreeCAD.Console.PrintMessage(
                "Clicked on position: (" + str(pos[0]) + ", " + str(pos[0]) + ")"
            )
            msg = " -> (%f,%f,%f)\n" % (pnt.x, pnt.y, pnt.z)
...
class TemplatePyMod_Cmd4:
    ...
    def GetResources(self):
        return {
            "Pixmap": "python",
            "MenuText": "Create spheres...",
            "ToolTip": "Click on the screen to create a sphere",
        }
...
class TemplatePyMod_Cmd6:
    ...
    def GetResources(self):
        return {
            "Pixmap": "python",
            "MenuText": "Create a box",
            "ToolTip": "Use Box feature class which is completely written in Python",
        }
...
class TemplatePyGrp_1:
    ...
    def GetResources(self):
        return {
            "Pixmap": "Part_JoinConnect",
            "MenuText": "TemplatePyGrp_1",
...
class TemplatePyGrp_2:
    ...
    def GetResources(self):
        return {
            "Pixmap": "Part_JoinEmbed",
            "MenuText": "TemplatePyGrp_2",
            "ToolTip": "Print a message",
        }
...
class TemplatePyGrp_3:
    ...
    def GetResources(self):
        return {
            "Pixmap": "Part_JoinCutout",
            "MenuText": "TemplatePyGrp_3",
            "ToolTip": "Print a message",
        }
...
class TemplatePyCheckable:
    ...
    def GetResources(self):
        return {
            "Pixmap": "python",
            "MenuText": "Toggle command",
            "ToolTip": "Example toggle command",
            "Checkable": True,
        }
