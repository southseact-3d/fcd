...
class TestImportCSG(unittest.TestCase):
    ...
    def test_import_text(self):
        ...
        try:
            doc = self.utility_create_scad(
                'text("X");', "text"
            )  # Keep it short to keep the test fast-ish
    ...
    def test_import_polygon_nopath(self):
        doc = self.utility_create_scad(
            "polygon(points=[[0,0],[100,0],[130,50],[30,50]]);", "polygon_nopath"
        )
    ...
    def test_import_polygon_path(self):
        doc = self.utility_create_scad(
            "polygon([[0,0],[100,0],[130,50],[30,50]], paths=[[0,1,2,3]]);", "polygon_path"
        )
...
""",
    ...
    def test_import_difference(self):
        doc = self.utility_create_scad(
            "difference() { cube(15, center=true); sphere(10); }", "difference"
        )
    ...
    def test_import_intersection(self):
        doc = self.utility_create_scad(
            "intersection() { cube(15, center=true); sphere(10); }", "intersection"
        )
        object = doc.ActiveObject
        self.assertTrue(object is not None)
    ...
    def test_import_rotate_extrude(self):
        doc = self.utility_create_scad(
            "rotate_extrude() translate([10, 0]) square(5);", "rotate_extrude_simple"
        )
        object = doc.ActiveObject
        self.assertTrue(object is not None)
        ...
        doc = self.utility_create_scad(
            "translate([0, 30, 0]) rotate_extrude() polygon( points=[[0,0],[8,4],[4,8],[4,12],[12,16],[0,20]] );",
            "rotate_extrude_no_hole",
        )
        object = doc.ActiveObject
        self.assertTrue(object is not None)
        ...
        doc = self.utility_create_scad(
            "rotate_extrude($fn=4, angle=180) polygon([[0,0],[3,3],[0,3]]);",
            "rotate_extrude_low_fn",
        )
        object = doc.ActiveObject
        self.assertTrue(object is not None)
        ...
        doc = self.utility_create_scad(
            "rotate_extrude($fn=4, angle=-180) polygon([[0,0],[3,3],[0,3]]);",
            "rotate_extrude_low_fn_negative_angle",
        )
        object = doc.ActiveObject
        self.assertTrue(object is not None)
        self.assertAlmostEqual(object.Shape.Volume, 9.0, 5)
        ...
        doc = self.utility_create_scad(
            "rotate_extrude(angle=180) polygon([[0,0],[3,3],[0,3]]);", "rotate_extrude_angle"
        )
        object = doc.ActiveObject
        self.assertTrue(object is not None)
        ...
        doc = self.utility_create_scad(
            "rotate_extrude(angle=-180) polygon([[0,0],[3,3],[0,3]]);",
            "rotate_extrude_negative_angle",
        )
        object = doc.ActiveObject
        self.assertTrue(object is not None)
        self.assertAlmostEqual(object.Shape.Volume, 4.5 * math.pi, 5)
    ...
    def test_import_linear_extrude(self):
        doc = self.utility_create_scad(
            "linear_extrude(height = 20) square([20, 10], center = true);", "linear_extrude_simple"
        )
        object = doc.ActiveObject
        self.assertTrue(object is not None)
        ...
        doc = self.utility_create_scad(
            "linear_extrude(height = 20, twist = 90) square([20, 10], center = true);",
        ...
        doc = self.utility_create_scad(
            "linear_extrude(height = 20, scale = 0.2) square([20, 10], center = true);",
            "linear_extrude_scale",
        )
        object = doc.ActiveObject
        self.assertTrue(object is not None)
        h = 20
        ...
        doc = self.utility_create_scad(
            "linear_extrude(height = 20, twist = 180, scale=0.2) square([20, 10], center = true);",
            "linear_extrude_twist_scale",
        )
        object = doc.ActiveObject
        self.assertTrue(object is not None)
...
resize(newsize = [0,0,10], auto = [0,0,0]) {
    ...
    def test_import_surface(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                doc = self.utility_create_scad(
                    f'surface(file = "{testfile}", center = true, convexity = 5);',
                    "surface_simple_dat",
                )
                object = doc.ActiveObject
                self.assertTrue(object is not None)
                ...
                testfile = join(self.test_dir, "Surface.dat").replace("\\", "/")
                doc = self.utility_create_scad(
                    f'surface(file = "{testfile}", convexity = 5);', "surface_uncentered_dat"
                )
                object = doc.ActiveObject
                self.assertTrue(object is not None)
                self.assertAlmostEqual(object.Shape.Volume, 275.000000, 6)
    ...
    def test_import_projection(self):
        base_shape = (
            "linear_extrude(height=5,center=true,twist=90,scale=0.5){square([1,1],center=true);}"
        )
        hole = "cube([0.25,0.25,6],center=true);"
        cut_shape = f"difference() {{ {base_shape} {hole} }}"

        doc = self.utility_create_scad(
            f"projection(cut=true) {base_shape}", "projection_slice_square"
        )
        ...
        doc = self.utility_create_scad(
            f"projection(cut=true) {cut_shape}", "projection_slice_square_with_hole"
        )
        object = doc.getObject("projection_cut")
        self.assertTrue(object is not None)
