...
class OpenSCADWorkbench(Workbench):
    ...
    def __init__(self):
        self.__class__.Icon = (
            FreeCAD.getResourceDir() + "Mod/OpenSCAD/Resources/icons/OpenSCADWorkbench.svg"
        )
    ...
    def Initialize(self):
        ...
        self.appendToolbar(QT_TRANSLATE_NOOP("Workbench", "OpenSCAD Tools"), toolbarcommands)
