...
__title__ = "PartDesign.CompoundTools._CommandCompoundFilter"
...
def cmdCreateCompoundFilter(name):
    ...
    FreeCADGui.addModule("PartDesign.CompoundTools.CompoundFilter")
    FreeCADGui.doCommand(
        "f = PartDesign.CompoundTools.CompoundFilter.makeCompoundFilter(name = '" + name + "')"
    )
