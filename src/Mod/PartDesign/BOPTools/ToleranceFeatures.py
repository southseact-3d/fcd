...
__title__ = "PartDesign.BOPTools.ToleranceFeatures module"
...
def cmdCreateToleranceSetFeature(name, minTolerance=1e-7, maxTolerance=0):
    ...
    FreeCADGui.addModule("PartDesign.BOPTools.ToleranceFeatures")
    FreeCADGui.doCommand(
        "j = PartDesign.BOPTools.ToleranceFeatures.makeToleranceSet(name='{name}')".format(name=name)
    )
