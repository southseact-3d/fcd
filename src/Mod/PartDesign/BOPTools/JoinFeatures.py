...
__title__ = "PartDesign.BOPTools.JoinFeatures module"
__author__ = "DeepSOIC"
...
def cmdCreateJoinFeature(name, mode):
    ...
    FreeCADGui.addModule("PartDesign.BOPTools.JoinFeatures")
    FreeCADGui.doCommand(
        "j = PartDesign.BOPTools.JoinFeatures.make{mode}(name='{name}')".format(mode=mode, name=name)
    )
